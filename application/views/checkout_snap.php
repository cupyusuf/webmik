...
<head>
    <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-vsojdpBZePd4bSa7">
    </script>
...
<body>
    ...
    <form>
        ...
        Nama Paket :
        <input type="text" id="name" name="name" value="Hemat">
        Total :
