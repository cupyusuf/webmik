...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Edit Manga</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header" style="background-color: #ea97ad;">
            <h3 class="card-title">Form Edit Manga</h3>
        ...
        <div class="card-body">
            ...
            echo form_open_multipart('admin/manga/edit/' . $manga->id_manga) ?>
            <div class="form-group">
                <label>Judul Manga</label>
                <input name="name_manga" class="form-control" placeholder="Enter Name Product"
                    value="<?= $manga->name_manga ?>">
            </div>
            <!-- text input -->
            <div class="form-group">
                <label>Genre</label>
                <select name="id_genre" class="form-control">
                    <option value="<?= $manga->id_genre ?>"> <?= $manga->name_genre ?> </option>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="textarea" placeholder="Place some text here"
                    style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $manga->description ?></textarea>
            </div>
            <div class="row">
                <div class="col-xl-9">
                    <div class="form-group">
                        <label>Sampul</label>
                        <input type="file" name="sampul_manga" class="form-control" id="preview_img">
                    </div>
                </div>
                <div class="col-xl-3">
                    <div class="form-group">
                        <img src="<?= base_url('assets/uploads/cover-manga/' .$manga->sampul_manga) ?>" alt="Image"
                            id="img_load" width="240px" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="form-group">
