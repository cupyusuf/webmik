    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                ...
                <span class="right badge badge-warning">Gold</span>
            </div>
        </div>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item menu-open">
                    <a href="<?= base_url('member/home') ?>" class="nav-link active">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>Dasbor</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= base_url('member/beli') ?>" class="nav-link">
                        <i class="nav-icon fas fa-cart-plus"></i>
                        <p>Beli Paket</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= base_url('member/genre') ?>" class="nav-link">
                        <i class="nav-icon fas fas fa-database"></i>
                        <p>Genre</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= base_url('member/manga') ?>" class="nav-link">
